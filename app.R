...
ui <- tagList(
  ...
  navbarPage(
    ...
    tabPanel("Inicio",
             sidebarPanel(
               h4("Una aplicación para analizar datos del videojuego Pokémon"),
               h5("Creada por David Torres Pascual (@DavidTweid)")
             ),
             mainPanel(
               img(src="https://s14.postimg.org/tdpnz4d5d/Poke_Stats.png", align = "center"),
               h3("Comparación de atributos"),
               h4("En este apartado puedes comparar los atributos de los diferentes pokémon 
                  según su tipo, generación o entre legendario/no legendario"),
               h3("Correlación entre atributos"),
               h4("En este apartado puedes analizar la correlación entre
    ...
    tabPanel("Comparación de atributos",
             ...
             sidebarPanel(
               h4("Comparación de atributos de tipos de Pokemon"),
